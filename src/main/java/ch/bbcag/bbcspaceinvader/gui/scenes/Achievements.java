...
public class Achievements {
    ...
    private void createScene() {
        ...
        if (kills) {
            HBox killsBox = createStatBox("Kills   ", 1);
            achievementsBox.getChildren().add(killsBox);
        }

        HBox healthTakenBox = createStatBox("Health Taken   ", healthTaken);
        achievementsBox.getChildren().addAll(healthTakenBox);
    ...
    public void getAchievements(boolean achievemnt) {
        achievemnt = true;
    }
